...
//         htmlString = `<div data-lift="${i}"class="lift" data-status="idle" data-previousFloor="0" data-occupiedFLoor='0'>
...
//     let activeLiftData = allLifts[State.activeLift-1].dataset;
//     console.log(`called from , ${callFloorNo} for lift no ${State.activeLift}`);

//     if(State.occupiedFloor[callFloorNo] === undefined & activeLiftData.status == "idle"){

//         State.occupiedFloor[activeLiftData.previousFloor] = undefined;
...
//         transition: ${ callFloorNo * 2 == 0 ? (activeLiftData.occupiedFloor - callFloorNo) * 2  : callFloorNo * 2  }s;`
// x
